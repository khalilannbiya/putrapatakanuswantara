...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('user/images/logo-ppn.png')}}">
    <link rel="shortcut icon" href="{{asset('user/images/logo-ppn.png')}}">
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="top-left">
                <div class="navbar-header">
                    {{-- <a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('ElaAdmin/images/logo.png')}}"
                            alt="Logo"></a> --}}
                    <a class="navbar-brand text-success" href="{{url('admin/abouts')}}"> <i class="fa fa-user-circle-o"
                            style="font-size:34px"></i> <span class="font-weight-bold "
                ...
                <div class="header-menu">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{asset('user/images/logo-ppn.png')}}"
                                alt="User Avatar">
                        </a>
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; 2021 PT. Putra Pataka Nuswantara
                    </div>
